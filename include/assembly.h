...
cudaError_t assm_cudaMemcpyFromSymbol(void*, const void*, size_t, size_t, enum cudaMemcpyKind);
cudaError_t assm_cudaMemcpyToArray(struct cudaArray*, size_t, size_t, const void*, size_t, enum cudaMemcpyKind);
cudaError_t assm_cudaMemcpyToSymbolAsync(const void*, const void*, size_t, size_t, enum cudaMemcpyKind, cudaStream_t);
cudaError_t assm_cudaMemcpyToSymbol(const void*, const void*, size_t, size_t, enum cudaMemcpyKind);
