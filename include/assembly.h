...
cudaError_t assm_cudaBindTexture(size_t*, const struct textureReference*, const void*, const struct cudaChannelFormatDesc*, size_t, struct rpc_latencies*);
cudaError_t assm_cudaBindTextureToArray(const struct textureReference*, const struct cudaArray*,const struct cudaChannelFormatDesc*, struct rpc_latencies*);
cudaError_t assm_cudaConfigureCall(dim3 gridDim, dim3 blockDim, size_t, cudaStream_t, struct rpc_latencies*);
cudaError_t assm_cudaDriverGetVersion(int*, struct rpc_latencies*);
cudaError_t assm_cudaFreeArray(struct cudaArray*, struct rpc_latencies*);
cudaError_t assm_cudaFreeHost(void*, struct rpc_latencies*);
cudaError_t assm_cudaFree(void*, struct rpc_latencies*);
cudaError_t assm_cudaFuncGetAttributes(struct cudaFuncAttributes*, const char*, struct rpc_latencies*);
cudaError_t assm_cudaGetDeviceCount(int*, struct rpc_latencies*);
cudaError_t assm_cudaGetDevice(int*, struct rpc_latencies*);
cudaError_t assm_cudaGetDeviceProperties(struct cudaDeviceProp*, int, struct rpc_latencies*);
cudaError_t assm_cudaGetLastError(struct rpc_latencies*);
cudaError_t assm_cudaGetTextureReference(const struct textureReference**, const char*, struct rpc_latencies*);
cudaError_t assm_cudaHostAlloc(void**, size_t, unsigned int, struct rpc_latencies*);
cudaError_t assm_cudaLaunch(const char*, struct rpc_latencies*);
cudaError_t assm_cudaMallocArray(struct cudaArray**, const struct cudaChannelFormatDesc*, size_t, size_t, unsigned int, struct rpc_latencies*);
cudaError_t assm_cudaMallocPitch(void**, size_t*, size_t, size_t, struct rpc_latencies*);
cudaError_t assm_cudaMalloc(void**, size_t, struct rpc_latencies*);
cudaError_t assm_cudaMemcpyAsync(void*, const void*, size_t, enum cudaMemcpyKind, cudaStream_t, struct rpc_latencies*);
cudaError_t assm_cudaMemcpyFromSymbol(void*, const char*, size_t, size_t, enum cudaMemcpyKind, struct rpc_latencies*);
cudaError_t assm_cudaMemcpyToArray(struct cudaArray*, size_t, size_t, const void*, size_t, enum cudaMemcpyKind, struct rpc_latencies*);
cudaError_t assm_cudaMemcpyToSymbolAsync(const char*, const void*, size_t, size_t, enum cudaMemcpyKind, cudaStream_t, struct rpc_latencies*);
cudaError_t assm_cudaMemcpyToSymbol(const char*, const void*, size_t, size_t, enum cudaMemcpyKind, struct rpc_latencies*);
cudaError_t assm_cudaMemcpy(void*, const void*, size_t, enum cudaMemcpyKind, struct rpc_latencies*);
cudaError_t assm_cudaMemGetInfo(size_t*, size_t*, struct rpc_latencies*);
cudaError_t assm_cudaMemset(void*, int, size_t, struct rpc_latencies*);
cudaError_t assm_cudaRuntimeGetVersion(int*, struct rpc_latencies*);
cudaError_t assm_cudaSetDeviceFlags(unsigned int, struct rpc_latencies*);
cudaError_t assm_cudaSetDevice(int, struct rpc_latencies*);
cudaError_t assm_cudaSetupArgument(const void*, size_t, size_t, struct rpc_latencies*);
cudaError_t assm_cudaSetValidDevices(int*, int, struct rpc_latencies*);
cudaError_t assm_cudaStreamCreate(cudaStream_t*, struct rpc_latencies*);
cudaError_t assm_cudaStreamDestroy(cudaStream_t, struct rpc_latencies*);
cudaError_t assm_cudaStreamQuery(cudaStream_t, struct rpc_latencies*);
cudaError_t assm_cudaStreamSynchronize(cudaStream_t, struct rpc_latencies*);
cudaError_t assm_cudaThreadExit(struct rpc_latencies*);
cudaError_t assm_cudaThreadSynchronize(struct rpc_latencies*);

void** assm__cudaRegisterFatBinary(void*, struct rpc_latencies*);
void   assm__cudaRegisterFunction(void**, const char*, char*, const char*, int, uint3*, uint3*, dim3*, dim3*, int*, struct rpc_latencies*);
void   assm__cudaRegisterTexture(void**, const struct textureReference*, const void**, const char*, int, int, int, struct rpc_latencies*);
void   assm__cudaRegisterVar(void**, char*, char*, const char*, int, int, int, int, struct rpc_latencies*);
void   assm__cudaUnregisterFatBinary(void** fatCubinHandle, struct rpc_latencies*);

const char* assm_cudaGetErrorString(cudaError_t, struct rpc_latencies*);
struct cudaChannelFormatDesc assm_cudaCreateChannelDesc(int x, int y, int z, int w, enum cudaChannelFormatKind, struct rpc_latencies*);
